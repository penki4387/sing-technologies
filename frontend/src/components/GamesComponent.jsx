  ...
  return (
    <div className="p-6 min-h-screen flex flex-col mb-20">
      ...
      <div className="flex justify-center items-center mt-8 space-x-2">
        <button
          className="px-4 py-2 bg-gray-700 text-gray-300 rounded-full hover:bg-blue-500 hover:text-white transition"
        ...
        {Array.from({ length: totalPages }, (_, i) => (
          <button
            ...
            className={`px-4 py-2 mx-1 rounded-full border ${
              currentPage === i + 1 ? 'bg-blue-500 text-white' : 'bg-gray-700 text-gray-300 border-gray-500'
